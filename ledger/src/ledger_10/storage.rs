...
use crate::ledger_10::LOG_TARGET;
use crate::ledger_10::ledger_storage_local::{
...
#[cfg(feature = "std")]
use {
	crate::ledger_10::ledger_storage_local::db::DB,
	crate::ledger_10::midnight_serialize_local::Tagged,
	crate::ledger_10::mn_ledger_local::structure::{ProofMarker, SignatureKind, Transaction},
	crate::ledger_10::transient_crypto_local::commitment::PureGeneratorPedersen,
};
...
/// hardfork, where a ledger-10 node starts from a ledger-8 `ledger-state[v13]`
/// genesis before the runtime upgrade migrates it to v9).
#[cfg(feature = "std")]
pub fn genesis_matches_this_version(genesis_state: &[u8]) -> bool {
	use crate::ledger_10::ledger_storage_local::DefaultDB;
	let expected =
		<crate::ledger_10::mn_ledger_local::structure::LedgerState<DefaultDB> as Tagged>::tag();
	// `peek_tag` reads the serialized header tag without deserializing the body.
	match crate::ledger_10::midnight_serialize_local::peek_tag(&mut std::io::Cursor::new(
		genesis_state,
	)) {
...
pub fn get_root(state: &[u8], network_id: Option<&str>) -> Result<Vec<u8>, GetRootError> {
	// Get empty state key
	use crate::ledger_10::api::Ledger;
	use crate::ledger_10::ledger_storage_local::{DefaultDB, storage::default_storage};

	let state: crate::ledger_10::mn_ledger_local::structure::LedgerState<DefaultDB> =
		crate::ledger_10::midnight_serialize_local::tagged_deserialize(state)
	...
	let mut bytes = vec![];
	crate::ledger_10::midnight_serialize_local::tagged_serialize(&state.as_typed_key(), &mut bytes)
...
{
	use crate::ledger_10::api::Ledger;
	use crate::ledger_10::ledger_storage_local::storage::default_storage;

	let state: crate::ledger_10::mn_ledger_local::structure::LedgerState<D> =
		crate::ledger_10::midnight_serialize_local::tagged_deserialize(&mut &initial_state[..])
...
pub fn init_storage_paritydb_separate<P: AsRef<std::path::Path>>(
	...
	alloc_with_initial_state::<crate::ledger_10::TransactionSignature, ParityDb>(genesis_state)
}
...
>(
	...
	alloc_with_initial_state::<
		crate::ledger_10::TransactionSignature,
