...
//! Ledger generation 10: the current ledger (`midnight-ledger-v10`, 10.1.0.0-alpha.1).
//!
//! Every module under `ledger_10/` binds the v10 ledger crates through the
//! `*_local` aliases declared below. Its `ledger_9/` counterpart is a separate
//! copy on purpose: `diff -r ledger_9 ledger_10` shows exactly where the two
//! generations diverge, and an edit here cannot leak into v9. Storage, serialisation
//! and base-crypto are the crates shared with v8/v9 - one arena for all three.

#[cfg(feature = "std")]
pub(crate) use {
	base_crypto as base_crypto_local, coin_structure_ledger_10 as coin_structure_local,
	ledger_storage_ledger_10 as ledger_storage_local,
	midnight_node_ledger_helpers::ledger_10 as helpers_local,
	midnight_serialize as midnight_serialize_local, mn_ledger_10 as mn_ledger_local,
	onchain_runtime_ledger_10 as onchain_runtime_local,
	transient_crypto_ledger_10 as transient_crypto_local, zswap_ledger_10 as zswap_local,
};
