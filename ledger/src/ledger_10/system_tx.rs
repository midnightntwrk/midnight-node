...
use crate::ledger_10::{mn_ledger_local::structure::SystemTransaction, types::LedgerApiError};
...
/// Not applicable to ledger-10: the block-rewards-to-treasury system tx was
