...
#[cfg(feature = "std")]
use crate::ledger_10::base_crypto_local::{hash::HashOutput, time::Timestamp};
...
#[cfg(feature = "std")]
impl From<crate::ledger_10::onchain_runtime_local::context::BlockContext> for BlockContext {
	fn from(value: crate::ledger_10::onchain_runtime_local::context::BlockContext) -> Self {
		Self {
...
#[cfg(feature = "std")]
impl TryFrom<BlockContext> for crate::ledger_10::onchain_runtime_local::context::BlockContext {
	type Error = Vec<u8>;
