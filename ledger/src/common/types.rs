...
#[derive(PassByCodec, Encode, Decode, Default, Debug, Eq, PartialEq, Clone)]
...
#[derive(PassByCodec, Encode, Decode, Default, Debug, PartialEq, Eq, Clone)]
...
#[derive(PassByCodec, Encode, Decode, Debug, Eq, PartialEq, Clone)]
...
#[derive(PassByCodec, Encode, Decode, Clone, Eq, PartialEq)]
...
#[derive(PassByCodec, Encode, Decode, Clone)]
