...
//! Ledger generation 10 (`midnight-ledger-v10`, 10.1.0.0-alpha.1).
//!
//! Every module under `ledger_10/` binds the v10 ledger crates through the aliases
//! declared below. Its `ledger_9/` counterpart is a separate copy on purpose:
//! `diff -r ledger_9 ledger_10` shows exactly where the two generations diverge,
//! and an edit here cannot leak into v9.
//!
//! v10 shares the storage/serialisation stack with v8/v9 (one `Storage` instance, one
//! parity-db); only the transient-crypto-4 cone - ledger, zswap, coin-structure, onchain-*,
//! zkir - is its own instance, hence the `*_ledger_10` aliases below.

/// Ledger generation implemented by this module.
pub const LEDGER_VERSION: u32 = 10;
...
pub const CRATE_NAME: &str = "mn-ledger-10";
pub use {
	base_crypto, coin_structure_ledger_10 as coin_structure,
	ledger_storage_ledger_10 as ledger_storage, midnight_serialize, mn_ledger_10 as mn_ledger,
	onchain_runtime_ledger_10 as onchain_runtime, transient_crypto_ledger_10 as transient_crypto,
	zkir_ledger_10 as zkir, zswap_ledger_10 as zswap,
};
...
pub use crate::ledger_10::{
	...
	mn_ledger::test_utilities::{PUBLIC_PARAMS, Pk, ProofServerProvider, test_resolver},
	mn_ledger::{
...
pub fn make_block_context(
	tblock: crate::ledger_10::base_crypto::time::Timestamp,
	parent_block_hash: crate::ledger_10::base_crypto::hash::HashOutput,
	last_block_time: crate::ledger_10::base_crypto::time::Timestamp,
) -> crate::ledger_10::onchain_runtime::context::BlockContext {
	crate::ledger_10::onchain_runtime::context::BlockContext {
		tblock,
		tblock_err: 30,
		parent_block_hash,
