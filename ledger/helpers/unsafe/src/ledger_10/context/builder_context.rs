...
///
/// The backend is either a local [`crate::ledger_10::LedgerContext`] (which owns a
/// [`crate::ledger_10::LedgerState`]) or, in the future, an indexer-backed client that answers the
...
pub trait BuilderContext<D: DB + Clone>: Send + Sync + 'static {
	...
	///
	/// The local backend checks against its [`crate::ledger_10::LedgerState`]; an indexer-backed
