...
/// instead of replaying every block into a local [`crate::ledger_10::LedgerState`] (see issue #1186).
///
/// This is a stub: its only purpose for now is to prove that [`BuilderContext`] is implementable by
/// something other than [`crate::ledger_10::LedgerContext`]. If any method below cannot be expressed
