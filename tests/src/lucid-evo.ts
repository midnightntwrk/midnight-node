...
export class LucidEvoTest {
  ...
  async register(
    ...
    // NOTE: we should use bech32 so that on-chain registration data is self describing
    const cardanoAddressHex = stringToUtf8Hex(cardanoAddress); //bech32ToHex(cardanoAddress);
