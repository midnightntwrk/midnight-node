...
**Creating PRs:** Use `gh pr create` to create pull requests. Prompt the user for a relevant JIRA ticket link. If no JIRA link is provided, create the PR with `-l skip-changes-check-jira`.
