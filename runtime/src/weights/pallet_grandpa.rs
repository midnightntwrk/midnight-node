...
impl<T: frame_system::Config> pallet_grandpa::WeightInfo for WeightInfo<T> {
	...
	/// `report_equivocation` is not what the benchmark measures. The GRANDPA
	/// benchmark emits `check_equivocation_proof`, which is not a member of the
	/// public `pallet_grandpa::WeightInfo` trait; this run measured it at
	/// 87_642_180 ps, recorded here for reference only.
