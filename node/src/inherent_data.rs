...
use midnight_primitives_native_token_management::NativeTokenObservationApi;
...
use midnight_primitives_mainchain_follower::{
	...
	idp::MidnightNativeTokenManagementInherentDataProvider,
};
...
pub(crate) struct ProposalCIDP<T> {
	...
	native_token_data_source: Arc<dyn MidnightNativeTokenObservationDataSource + Send + Sync>,
}
	...
	T::Api: NativeTokenObservationApi<Block>,
{
	type InherentDataProviders = (
		...
		MidnightNativeTokenManagementInherentDataProvider,
	);
	...
	async fn create_inherent_data_providers(
		...
		let native_token = MidnightNativeTokenManagementInherentDataProvider::new(
			client.clone(),
