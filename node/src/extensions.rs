...
use midnight_primitives_ledger::{LedgerMetrics, LedgerMetricsExt};
...
impl<Block> ExtensionsFactory<Block> {
	pub fn new(ledger_metrics: Arc<Mutex<Option<LedgerMetrics>>>) -> Self {
		Self { ledger_metrics, _marker: Default::default() }
	}
}
	...
	Block: BlockT,
{
	fn extensions_for(
		...
		// Place to add more extensions if necessary
