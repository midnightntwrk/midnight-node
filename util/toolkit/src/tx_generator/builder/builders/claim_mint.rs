...
use crate::builder::{
	BuildTxs, BuilderArgs, ClaimMintInfo, DefaultDB, DeserializedTransactionsWithContext,
	FromContext, HashOutput, LedgerContext, MintCoinInfo, NIGHT, Nonce, ProofProvider, ProofType,
	SignatureType, TransactionWithContext, Wallet,
};

const CLAIM_MINT_AMOUNT: u128 = 500_000;
