...
use crate::fetcher::{
	...
	runtimes::{
		...
		MidnightMetadata0_20_1, MidnightMetadata0_21_0, RuntimeVersion, RuntimeVersionError,
	},
};
	...
	>(
		...
		match version_number {
			...
			RuntimeVersion::V0_20_1 => {
				Self::process_block_with_protocol::<MidnightMetadata0_20_1, S, P, D>(block).await
			},
