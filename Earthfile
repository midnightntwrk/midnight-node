...
rebuild-genesis-state:
    ...
    # wallet-seed-4 through wallet-seed-19 use their decimal index as the seed value.
    # Seeds 0x..37 (toolkit RNG seed) and 0x..52 (registered-but-unfunded e2e wallet) must stay unfunded.
