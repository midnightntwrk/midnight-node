...
toolkit-js-prep:
    ...
    RUN compactc ./test/contract/counter.compact ./test/contract/managed/counter
    RUN compactc ./test/ut_contract/unshielder.compact ./test/ut_contract/out
    RUN compactc ./mint/mint.compact ./mint/out
