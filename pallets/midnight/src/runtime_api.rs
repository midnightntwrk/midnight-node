...
use crate::{TransactionType, TransactionTypeV2};
...
sp_api::decl_runtime_apis! {
	...
	pub trait MidnightRuntimeApi {
		#[changed_in(2)]
		fn get_contract_state_json(contract_address: Vec<u8>) -> Vec<u8>;
		...
		#[changed_in(2)]
		fn get_decoded_transactions(extrinsics: Vec<Block::Extrinsic>) -> Vec<TransactionType>;
		fn get_decoded_transactions(extrinsics: Vec<Block::Extrinsic>) -> Vec<TransactionTypeV2>;
		#[changed_in(2)]
