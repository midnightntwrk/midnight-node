...
//! # Prerequisites
//!
//! This feature uses the [InherentDigest] mechanism from [sp_partner_chains_consensus] crate for storing inherent
...
//! ```
//!
//! [PartnerChainsProposer]: sp_partner_chains_consensus::PartnerChainsProposer
//! [PartnerChainsProposerFactory]: sp_partner_chains_consensus::PartnerChainsProposerFactory
